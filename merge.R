...
for (i in 1:1){
  ...
  data_30 <- read.csv(paste("D:/Josefina/paper_git/paper_maiac/datasets/V02/processed/merge_AER-MAIAC/Latam_C61/dia/",buffer,"km/",number,"_",city,"-",buffer,"km-MAIAC-30-AER_MEAN_c61.csv",sep=""))
  data_60 <- read.csv(paste("D:/Josefina/paper_git/paper_maiac/datasets/V02/processed/merge_AER-MAIAC/Latam_C61/dia/",buffer,"km/",number,"_",city,"-",buffer,"km-MAIAC-60-AER_MEAN_c61.csv",sep=""))
  data_90 <- read.csv(paste("D:/Josefina/paper_git/paper_maiac/datasets/V02/processed/merge_AER-MAIAC/Latam_C61/dia/",buffer,"km/",number,"_",city,"-",buffer,"km-MAIAC-90-AER_MEAN_c61.csv",sep=""))
  data_120 <- read.csv(paste("D:/Josefina/paper_git/paper_maiac/datasets/V02/processed/merge_AER-MAIAC/Latam_C61/dia/",buffer,"km/",number,"_",city,"-",buffer,"km-MAIAC-120-AER_MEAN_c61.csv",sep=""))
  ...
  dir <- "D:/Josefina/paper_git/paper_maiac/datasets/V02/processed/merge_BUFFER/Latam_C61/horario/"
...
for (i in 1:1){
  ...
  data_1 <- read.csv(paste("D:/Josefina/paper_git/paper_maiac/datasets/V02/processed/merge_AER-MAIAC/Latam_C61/dia/1km/",number,"_",city,"-","1km-MAIAC-",buffer,"-AER_MEAN_c61.csv",sep=""))
  data_3 <- read.csv(paste("D:/Josefina/paper_git/paper_maiac/datasets/V02/processed/merge_AER-MAIAC/Latam_C61/dia/3km/",number,"_",city,"-","3km-MAIAC-",buffer,"-AER_MEAN_c61.csv",sep=""))
  data_5 <- read.csv(paste("D:/Josefina/paper_git/paper_maiac/datasets/V02/processed/merge_AER-MAIAC/Latam_C61/dia/5km/",number,"_",city,"-","5km-MAIAC-",buffer,"-AER_MEAN_c61.csv",sep=""))
  data_15 <- read.csv(paste("D:/Josefina/paper_git/paper_maiac/datasets/V02/processed/merge_AER-MAIAC/Latam_C61/dia/15km/",number,"_",city,"-","15km-MAIAC-",buffer,"-AER_MEAN_c61.csv",sep=""))
  data_25 <- read.csv(paste("D:/Josefina/paper_git/paper_maiac/datasets/V02/processed/merge_AER-MAIAC/Latam_C61/dia/25km/",number,"_",city,"-","25km-MAIAC-",buffer,"-AER_MEAN_c61.csv",sep=""))
  ...
  dir <- "D:/Josefina/paper_git/paper_maiac/datasets/V02/processed/merge_BUFFER/Latam_C61/espacial/"
